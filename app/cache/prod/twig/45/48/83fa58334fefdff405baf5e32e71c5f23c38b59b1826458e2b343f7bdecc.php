  ...
  <body>
    ...
    public function block_historique($context, array $blocks = array())
    {
        ...
        echo "          
            <a href=\"";
        // line 37
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("historique", array("id" => $this->getAttribute((isset($context["visiteur"]) ? $context["visiteur"] : null), "id", array()))), "html", null, true);
        echo "\">Historique</a>
    ...
    public function block_saisie($context, array $blocks = array())
    {
        ...
        echo "          
            <a href=\"";
        // line 44
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("visiteur", array("id" => $this->getAttribute((isset($context["visiteur"]) ? $context["visiteur"] : null), "id", array()))), "html", null, true);
