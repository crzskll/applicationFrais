...
class __TwigTemplate_2cc6d548efd27df5d40a74485ee6250777c8686853349d4c72a5518eb91047a1 extends Twig_Template
{
    ...
    <table class=\"record_properties\">
        ...
        echo "</td>
            ...
            <tr>
                ...
                <td>";
        // line 18
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["entity"]) ? $context["entity"] : $this->getContext($context, "entity")), "nbJustificatifs", array()), "html", null, true);
        echo "</td>
            </tr>
            <tr>
        ...
        echo "</td>
            ...
            <tr>
                ...
                <td>";
        // line 26
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["entity"]) ? $context["entity"] : $this->getContext($context, "entity")), "montantValide", array()), "html", null, true);
        echo "</td>
            </tr>
            <tr>
                <th>Refusligne</th>
                <td>";
        // line 30
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["entity"]) ? $context["entity"] : $this->getContext($context, "entity")), "refusLigne", array()), "html", null, true);
        echo "</td>
            </tr>
        </tbody>
    </table>
    ...
    <li>
        <a href=\"";
        // line 42
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("gsb_fiche_edit", array("id" => $this->getAttribute((isset($context["entity"]) ? $context["entity"] : $this->getContext($context, "entity")), "id", array()))), "html", null, true);
        echo "\">
            Edit
        </a>
    </li>
