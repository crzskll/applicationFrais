...
class LoadHorsForfaitLigneData extends AbstractFixture implements OrderedFixtureInterface {
	public function load(ObjectManager $em) {
		...
		$horsForfaitLigne1_fiche1_visit1->setStatut($em->merge($this->getReference('statut-validee')));
		$horsForfaitLigne1_fiche1_visit1->setFiche($em->merge($this->getReference('fiche_visiteur1_1')));
		...
		$horsForfaitLigne2_fiche1_visit1->setStatut($em->merge($this->getReference('statut-refusee')));
		$horsForfaitLigne2_fiche1_visit1->setFiche($em->merge($this->getReference('fiche_visiteur1_1')));
		...
		$horsForfaitLigne1_fiche1_visit2->setStatut($em->merge($this->getReference('statut-validee')));
		$horsForfaitLigne1_fiche1_visit2->setFiche($em->merge($this->getReference('fiche_visiteur2')));
