...
class HorsForfaitLigneController extends Controller
{
    ...
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('admin_hors_forfait_ligne_show', array('id' => $entity->getId())));
        }
    ...
    private function createCreateForm(HorsForfaitLigne $entity)
    {
        $form = $this->createForm(new HorsForfaitLigneType(), $entity, array(
            'action' => $this->generateUrl('admin_hors_forfait_ligne_create'),
            'method' => 'POST',
        ));
    ...
    */
    ...
    {
        $form = $this->createForm(new HorsForfaitLigneType(), $entity, array(
            'action' => $this->generateUrl('admin_hors_forfait_ligne_update', array('id' => $entity->getId())),
            'method' => 'PUT',
        ));
    ...
    public function updateAction(Request $request, $id)
    {
        ...
        if ($editForm->isValid()) {
            ...
            return $this->redirect($this->generateUrl('admin_hors_forfait_ligne_edit', array('id' => $id)));
        }
    ...
    public function deleteAction(Request $request, $id)
    {
        ...
        return $this->redirect($this->generateUrl('admin_hors_forfait_ligne'));
    }
    ...
    private function createDeleteForm($id)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('admin_hors_forfait_ligne_delete', array('id' => $id)))
            ->setMethod('DELETE')
