...
use Gsb\AppliFraisBundle\Form\EtatType;
...
class EtatController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('GsbAppliFraisBundle:Etat')->findAll();

        return $this->render('GsbAppliFraisBundle:Etat:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('GsbAppliFraisBundle:Etat')->find($id);
        ...
        return $this->render('GsbAppliFraisBundle:Etat:show.html.twig', array(
            'entity'      => $entity,
